...
public class InputPrompter : MonoBehaviour
{
	...
	{
		print($"Requesting {code} {position}");
	...
	void Start()
	{
		...
		Dictionary<string, Sprite> string_sprite_map = AssetTools.MapResources<Sprite>(input_code_names, "Input Prompts");
