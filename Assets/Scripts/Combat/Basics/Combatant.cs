...
public class Combatant : MonoBehaviour
{
	...
	/// <summary>
	/// Integrate damage attack damage,
	/// and trigger appropriate events based on
	/// combatant state and attack lethality.
	/// </summary>
	...
	/// <summary>
	/// Enqueue an attack if it is from
	/// a hostile and this combatant
	/// is not invincible or in hurt
	/// cooldown
	/// </summary>
	/// <param name="attack"></param>
	/// <returns></returns>
	...
	/// <summary>
	/// Attack all hostiles within a radius
	/// </summary>
	...
	/// <summary>
	/// Attack all hostiles within a radius
	/// and arc, with the arc being centered
	/// on a phase shift
	/// </summary>
	/// <param name="radius"></param>
	...
	/// <summary>
	/// Instantaneously move this combatant
	/// to a destination, constrained by the
	/// dimensions of this combatant's arena
	/// </summary>
